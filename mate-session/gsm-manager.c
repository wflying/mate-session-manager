...
static GtkWidget *win_dialog = NULL;
...
/* add by cs2c*/
void
request_hibernate_cb (GtkButton *bt, gpointer userdata)
{
       GsmManager *manager = userdata;
...
/* add by cs2c*/
void
request_suspend_cb (GtkButton *bt, gpointer userdata)
{
       GsmManager *manager = userdata;
...
/* add by cs2c*/
void
request_shutdown_cb (GtkButton *bt, gpointer userdata)
{
       GsmManager *manager = userdata;
       request_shutdown(manager);
}
/* add by cs2c*/
void
request_reboot_cb (GtkButton *bt, gpointer userdata)
{
       GsmManager *manager = userdata;
       request_reboot(manager);
}
/* add by cs2c*/
void
request_switch_cb (GtkButton *bt, gpointer userdata)
{
       GsmManager *manager = userdata;
...
/* add by cs2c*/
void
request_logout_cb (GtkButton *bt, gpointer userdata)
{
       GsmManager *manager = userdata;
       request_logout(manager, FALSE);
}
...
show_shutdown_dialog (GsmManager *manager)
{
        ...
        g_signal_connect (dialog,
                          ...
                          manager);
#endif
        dialog = win_shutdown_dialog(gdk_screen_get_default(), manager);
        win_dialog = dialog;
...
show_logout_dialog (GsmManager *manager)
{
        ...
        g_signal_connect (dialog,
                          ...
                          manager);
#endif
	dialog = win_logout_dialog(gdk_screen_get_default(), manager);
        win_dialog = dialog;
        gtk_widget_show (dialog);
}
