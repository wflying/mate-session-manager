...
void                request_hibernate_cb (GtkButton *bt, gpointer userdata);
void                request_suspend_cb (GtkButton *bt, gpointer userdata);
void                request_shutdown_cb (GtkButton *bt, gpointer userdata);
void                request_reboot_cb (GtkButton *bt, gpointer userdata);
void                request_switch_cb (GtkButton *bt, gpointer userdata);
void                request_logout_cb (GtkButton *bt, gpointer userdata);
#ifdef __cplusplus
}
#endif
